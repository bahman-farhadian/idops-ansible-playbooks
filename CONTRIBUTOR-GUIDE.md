...
comments. Every value is live, at its current tracked default (now a blank
placeholder), ready to edit in place — nothing needs to be uncommented before
it takes effect. Filling in real values here is what makes the project able
to run at all.
